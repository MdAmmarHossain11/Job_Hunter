...
<head>
	...
	<title>Job Hunter <?php echo "$title"; ?></title>
    ...
    <meta property="og:image:alt" content="Job Hunter" />
		...
		<div class="main-wrapper">
			...
			<div class="second-search-result-wrapper">
				...
				<div class="container">
					...
					<form action="jobs.php" method="GET" autocomplete="off">
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="jobs.php?page='.$prevpage.''; ?> <?php if ($fromsearch == true) { print '&category='.$cate.'&country='.$country.'&search=✓'; }'';} print '"><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="jobs.php?page=<?php echo "$b"; ?><?php if ($fromsearch == true) { print '&category='.$cate.'&country='.$country.'&search=✓'; }?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="jobs.php?page='.$nextpage.''; ?> <?php if ($fromsearch == true) { print '&category='.$cate.'&country='.$country.'&search=✓'; }'';} print '"><i class="fa fa-chevron-right"></i></a></li>';
					             }
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job Hunter</h5>
											<p>UIU Job Hunter is a job portal, online job management system which developed by Team Al-Fatah</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : United City, Badda, Dhaka</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?>Team Al-Fatah</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Team Al-Fatah</a></li>
								</ul>
