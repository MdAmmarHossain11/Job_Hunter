...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/001.avif');">
				<div class="container">

					<h1>Welcome to UIU Job Hunter</h1>
					<p>Find your next career on UIU Job Hunter</p>
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
                    ...
                    $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employer' ORDER BY rand() LIMIT 5");
                    $stmt->execute();
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						$conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
						$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$stmt = $conn->prepare("SELECT * FROM tbl_jobs ORDER BY enc_id DESC LIMIT 3");
						$stmt->execute();
						$result = $stmt->fetchAll();
